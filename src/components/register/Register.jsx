        ...
        <div className="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6">
            <div>
              <label
                htmlFor="name"
                className="block text-lg font-bold gray-700"
              >
                Enter Name
              </label>
              <div className="mt-2">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label
                  htmlFor="remember-me" className="pl-2 text-sm text-gray-500"
                >
                  Remember Me
                </label>
              </div>
            ...
            bg-blue-500 hover:bg-blue-700 text-white rounded-md font-medium`}
              >
                Login
              </button>
            </div>
