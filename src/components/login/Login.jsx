      ...
      <div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md'>
        <div className='px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10'>
          <form className='space-y-6'>
            ...
            <div className='flex items-center'>
              <button type='submit'className='relative w-full group h-{40px} flex justify-center py-2 px-4 border-transpert bg-green-500 hover:bg-green-700 text-white rounded-md font-medium'>Login</button>
            </div>
